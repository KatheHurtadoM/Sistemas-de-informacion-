        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img width="130" height="30"
                         src="http://www.cruzimex.com/wp-content/uploads/2017/08/logo-cruzimex-s.png" alt="logo">
                </a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @else
                        ...
                        @else
                            <li>
                                <a href="{{ route('productos.ver') }}">
                                    Productos
                                </a>
                            </li>

                            <li>
                                <a href="{{ route('ordenes.ver') }}">
                                    Ordenes
                                </a>
                            </li>
                        @endif
